...
class NewStockViewModel extends ReactiveViewModel {
  ...
  Future<void> recordNewStock(context) async {
    List newRecords = [];
    ...
    try {
      var data = {'check_in_id': checkInData!.id, 'store_id': checkInData!.storeId, 'products': newRecords};
